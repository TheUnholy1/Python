...
def mirrored_string(my_string):
    ...
    # I added another condition that says forwards should not be equal to an empty string
    #because the condition turns true if you insert numbers only because it returns an empty string for both
    if forwards.lower() == backwards.lower() and forwards != "":
        return True
    return False
...
print(mirrored_string("12")) # Should be False
print()
print("Skill Group 2 (.format())\n")
...
print()
print("Skill Group 3 format() with Index Slicing\n")
...
print("Skill Group 4 replace() with len()\n")
...
#basically this thing just replaces it if it is in the end of the string

print()
print("Another Replace method with Index Slicing using Len")
print()
